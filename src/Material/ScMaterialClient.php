...
class ScMaterialClient extends BaseClient implements IHttpRequestInterface
{
    /**
     * @param $start_dsr
     * @return $this
    ...
    public function get()
    {
        $requestParamters = ['adzone_id', 'site_id'];
        $this->checkRequired($requestParamters);
        return $this->httpGet('taobao.tbk.sc.material.optional');
    }
}
